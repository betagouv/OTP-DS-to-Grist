...
def normalize_key(key_string):
    """
    Normalise une clé en supprimant les caractères spéciaux
    et en convertissant en minuscule pour garantir une correspondance cohérente
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for col in geo_columns:
                if col["id"] not in actual_columns and col["id"] not in [
                    c["id"] for c in missing_columns
                ]:
